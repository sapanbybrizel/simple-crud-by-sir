...
<div class="container py-5">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('user_update',[$user->id]) }}" method="POST" class="">
                @csrf
                @method('PATCH')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="mobile" class="form-control" name="mobile" value="{{ old('mobile',$user->mobile) }}" placeholder="Enter mobile">
                    @error('mobile')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
